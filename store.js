...
function ready() {
    ...
    var quantityInputs = document.getElementsByClassName('cart-quan-input')
...
function updateCartTotal() {
    ...
    for (var i = 0; i < cartRows.length; i++) {
        ...
        var quantityElement = cartRow.getElementsByClassName('cart-quan-input')[0]
